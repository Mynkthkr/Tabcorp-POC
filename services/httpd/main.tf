module "ecs_service" {
  ...
  load_balancer = {
    service = {
      target_group_arn = "${aws_lb_target_group.this.arn}"         #"${data.aws_lb_target_group.test.arn}"      #local.workspace.container_definitions.target_group_arn
  ...
  security_group_rules = {
    alb_ingress_3000 = {
      ...
      source_security_group_id = "sg-0dbaa5f7ef064318e"
    }
    egress_all = {
      type        = "egress"
      from_port   = 0
...
resource "aws_lb_listener_rule" "this" {
  ...
  priority     = 200      #pendingToBeInConfig
...
# module "alb_tg" {
#   source = "git::https://github.com/nitinda/terraform-module-aws-lb-tg"
...
#   # ALB Target Group
#   name                 = "httpdtg"          #var.target_group_name
#   port                 = 80               #var.target_group_port
#   protocol             = "HTTP"             #var.target_group_protocol
#   vpc_id               = "vpc-09b0d790fb82b19fa"        #var.vpc_id
#   target_type          = "instance"                #var.target_group_type
